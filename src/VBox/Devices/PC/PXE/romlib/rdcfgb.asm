; $Id: rdcfgb.asm 114041 2026-04-28 12:05:18Z knut.osmundsen@oracle.com $
;; @file
; PXE - VBox implementation of @pci_read_config_byte
;
...
;        unsigned func, unsigned reg, byte *p_data)
;
...
@pci_read_config_byte proc near
        ; Save used registers.
        push    bp
        mov     bp, sp
        push    di
        ...
        PCI_READ_BYTE           ; call PCI BIOS service

        mov     ax,0            ; set return code
        adc     ax,0

        mov     di,[bp+6]       ; load destination address
        mov     [di],cl         ; store byte read from config space
