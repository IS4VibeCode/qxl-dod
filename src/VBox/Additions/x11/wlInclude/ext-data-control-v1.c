...
/* wayland-scanner --include-core-only --strict public-code ./ext-data-control-v1.xml ./ext-data-control-v1.c */
...
WL_EXPORT const struct wl_interface ext_data_control_manager_v1_interface = {
...
WL_EXPORT const struct wl_interface ext_data_control_device_v1_interface = {
...
WL_EXPORT const struct wl_interface ext_data_control_source_v1_interface = {
...
WL_EXPORT const struct wl_interface ext_data_control_offer_v1_interface = {
