...
SUPHARNT_IMPORT_SYSCALL_HASH_STACK(NtDelayExecution, 8)
...
SUPHARNT_IMPORT_SYSCALL_HASH_STACK(NtWaitForMultipleObjects, 20)
SUPHARNT_IMPORT_SYSCALL_HASH_STACK(NtWaitForSingleObject, 12)
SUPHARNT_IMPORT_SYSCALL(NtWriteFile, 36)
SUPHARNT_IMPORT_SYSCALL(NtWriteVirtualMemory, 20)
SUPHARNT_IMPORT_SYSCALL_HASH_STACK(NtYieldExecution, 0)
