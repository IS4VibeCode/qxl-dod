...
- All the above is the same as for the AccessControl/amd64 package.
- run: mkdir nsProcess-amd64
- run: cd nsProcess-amd64
- run: 7z x <dlpath>\nsProcess.zip
...
- run: cl /Zi /LD /W3 /O1 /GF /GS- /GR- /GL /Zl /Osy /Ogsy /DUNICODE /D_UNICODE ^
        /I../../Source ^
...
- run: %MY_VBOX_PE_SET_VERSION% --xp64 nsProcess.dll
- run: RTLdrCheckImports -p %MY_VBOX_ROOT%\tools\win.amd64\exports\xp64 nsProcess.dll
- run: copy nsProcess.dll ..\..\Plugins\amd64-unicode
- run: copy nsProcess.pdb ..\..\Plugins\amd64-unicode
- run: cd ..\..\
- run: mkdir Docs Docs\NsProcess
- run: copy Readme.txt Docs\NsProcess
- run: copy ..\readme-NsProcess-amd64.tool
- run: zip -9Xr ..\win.amd64.nsis.v3.10-log-NsProcess-v1.6.zip Plugins Include Docs readme-NsProcess-amd64.tool
