Linux centos4u8 build of nasm v2.16.03 tarball (nasm-2.16.03.tar.gz, md5: 
128ad3b6194226562d7e6240de9f0a5e) with github pull request 80 applied 
(attached below) targeting amd64. Dynamically linking glibc.

No configure arguments. No make arguments. Debug info not stripped.
