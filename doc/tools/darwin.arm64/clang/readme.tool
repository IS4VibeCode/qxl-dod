...
cmake --install . --prefix /Users/vbox/darwin.arm64.clang

# Remove unnecessary stuff to keep the tools package as small as possible

cd /Users/vbox/darwin.arm64.clang
rm bin/amdgpu-arch
rm bin/bugpoint
rm bin/c-index-test
rm bin/clang-check
...
tar -cf ../darwin.arm64.clang.v20.1.1.tar *
cd ..
bzip2 -9 darwin.arm64.clang.v20.1.1.tar
