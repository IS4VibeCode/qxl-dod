@echo off
rem $Id: env-amd64.cmd 113977 2026-04-22 20:32:22Z knut.osmundsen@oracle.com $
rem rem @file
rem usage: env-amd64.cmd
rem
...
:have_vcinstalldir
if not "%PROCESSOR_ARCHITECTURE%"=="AMD64" set PATH=%VCINSTALLDIR%\bin\Host%PROCESSOR_ARCHITECTURE%\x64;%VCINSTALLDIR%\bin\Host%PROCESSOR_ARCHITECTURE%\%PROCESSOR_ARCHITECTURE%;%PATH%
if "%PROCESSOR_ARCHITECTURE%"=="AMD64"     set PATH=%VCINSTALLDIR%\bin\Hostx64\x64;%PATH%
set INCLUDE=%VCINSTALLDIR%\include;%VCINSTALLDIR%\atlmfc\include;%INCLUDE%
set     LIB=%VCINSTALLDIR%\lib\x64;%VCINSTALLDIR%\atlmfc\lib\x64;%LIB%
set LIBPATH=%VCINSTALLDIR%\lib\x64;%VCINSTALLDIR%\atlmfc\lib\x64;%LIBPATH%
goto end
