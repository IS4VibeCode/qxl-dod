@echo off
rem $Id: env-arm64.cmd 113977 2026-04-22 20:32:22Z knut.osmundsen@oracle.com $
rem rem @file
rem usage: env-arm64.cmd
rem
...
:have_vcinstalldir
if "%PROCESSOR_ARCHITECTURE%"=="AMD64"     set PATH=%VCINSTALLDIR%\bin\Hostx64\arm64;%PATH%
if not "%PROCESSOR_ARCHITECTURE%"=="AMD64" set PATH=%VCINSTALLDIR%\bin\Host%PROCESSOR_ARCHITECTURE%\arm64;%PATH%
set INCLUDE=%VCINSTALLDIR%\include;%VCINSTALLDIR%\atlmfc\include;%INCLUDE%
set     LIB=%VCINSTALLDIR%\lib\arm64;%VCINSTALLDIR%\atlmfc\lib\arm64;%LIB%
set LIBPATH=%VCINSTALLDIR%\lib\arm64;%VCINSTALLDIR%\atlmfc\lib\arm64;%LIBPATH%
goto end
