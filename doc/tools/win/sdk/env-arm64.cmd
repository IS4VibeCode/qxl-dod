...
:remainder
set PATH=%MYSDK%\Bin\arm64;%MYSDK%\Bin\%MYSDKVER%\arm64;%MYSDK%\Bin\x86;%MYSDK%\Bin\%MYSDKVER%\x86;%PATH%
if "%1"=="--ucrt" set INCLUDE=%MYSDK%\Include\%MYSDKVER%\ucrt;%INCLUDE%
if "%1"=="--ucrt" set LIB=%MYSDK%\Lib\%MYSDKVER%\ucrt\arm64;%LIB%
set INCLUDE=%MYSDK%\Include\%MYSDKVER%\um;%MYSDK%\Include\%MYSDKVER%\shared;%INCLUDE%
set LIB=%MYSDK%\Lib\%MYSDKVER%\um\arm64;%LIB%
goto end
