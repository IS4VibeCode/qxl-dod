# QXL WDDM 1.1 driver for Windows 7 (fork of Oracle VirtualBox)

This fork grafts SPICE's [qxl-wddm-dod](https://gitlab.freedesktop.org/spice/win32/qxl-wddm-dod)
QXL device-communication code onto VirtualBox's WDDM 1.1 miniport driver
scaffolding, to build a genuine WDDM 1.1 display driver for QEMU's QXL device
under Windows 7 (enabling Aero/DWM composition). The bulk of this tree is
unmodified Oracle VirtualBox source, described below.
