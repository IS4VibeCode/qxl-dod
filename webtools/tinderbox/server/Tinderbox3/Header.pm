...
sub header {
  ...
  print $p->header(-charset => 'utf8', -cookie => $cookie);
  print <<EOM;
<html>
<head>
...
sub nav_links {
  ...
  if ($tree) {
    print "<br>Tree $tree: <a href='sheriff.pl?tree=$tree'>Sheriff Tree</a> | <a href='admintree.pl?tree=$tree'>Edit Tree</a> | <a href='showbuilds.pl?tree=$tree'>View Tree</a> | <a href='showtests.pl?tree=$tree'>Test Tree View</a>\n";
    if ($machine_id) {
